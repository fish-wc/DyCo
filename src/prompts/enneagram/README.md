...
Reserved directory for role-prior prompts under DyCo using Enneagram as an alternative testbed. MBTI is only the current interpretable baseline.

## Quick migration
- Mirror the MBTI prompt layout under prompts/enneagram/<label>/.
